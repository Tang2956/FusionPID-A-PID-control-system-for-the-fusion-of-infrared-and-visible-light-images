...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_untitled_restored_from_autosave_process_check_sum_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_untitled_restored_from_autosave_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_untitled_restored_from_autosave_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "untitled_restored_from_autosave") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_untitled_restored_from_autosave_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_untitled_restored_from_autosave_jit_fallback_info( int
  ...
  if (strcmp(machineName, "untitled_restored_from_autosave") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_untitled_restored_from_autosave_jit_fallback_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_untitled_restored_from_autosave_get_post_codegen_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "untitled_restored_from_autosave") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_untitled_restored_from_autosave_get_post_codegen_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_untitled_restored_from_autosave_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "untitled_restored_from_autosave") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_untitled_restored_from_autosave_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_untitled_restored_from_autosave_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "untitled_restored_from_autosave") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_untitled_restored_from_autosave_get_eml_resolved_functions_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int sf_untitled_restored_from_autosave_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"untitled_restored_from_autosave")) {
    return(sf_untitled_restored_from_autosave_method_dispatcher(simstructPtr,
...
extern void untitled_restored_from_autosave_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    untitled_restored_from_autosave_terminator();
  }

  return;
}

extern void untitled_restored_from_autosave_initializer(void);
extern void untitled_restored_from_autosave_register_exported_symbols(SimStruct*
  S);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  untitled_restored_from_autosave_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    untitled_restored_from_autosave_initializer();
  }
