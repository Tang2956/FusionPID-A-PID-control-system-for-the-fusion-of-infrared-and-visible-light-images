  ...
  (SFc5_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 3, 0,
    c5_d_covSaturation);
  c5_I11 = (uint8_T)c5_u3;
  c5_b_q0 = c5_b_I1;
  c5_b_qY = c5_b_q0 - (uint32_T)c5_I11;
  ...
  c5_b = c5_g_y;
  c5_i_x = c5_b;
  c5_b_b = muDoubleScalarIsNaN(c5_i_x);
  if (c5_b_b) {
    c5_p = false;
  } else {
    c5_p = ((real_T)c5_a > c5_b);
  }

  if (c5_p) {
    c5_d3 = muDoubleScalarRound(c5_g_y);
    ...
    if (c5_d3 < 256.0) {
      if (c5_d3 >= 0.0) {
        ...
        c5_u5 = 0U;
        sf_data_saturate_error(chartInstance->S, 1U, 578, 10);
      }
    } else if (c5_d3 >= 256.0) {
      c5_f_covSaturation = true;
      c5_u5 = MAX_uint8_T;
  ...
  c5_I41 = c5_I22;
  c5_c_q0 = c5_I23;
  c5_c_qY = c5_c_q0 - (uint32_T)c5_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 6, 0,
    c5_g_covSaturation);
  c5_I51 = (uint8_T)c5_u6;
  c5_d_q0 = c5_I11;
  c5_d_qY = c5_d_q0 - (uint32_T)c5_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 7, 0,
    c5_h_covSaturation);
  c5_I61 = (uint8_T)c5_u7;
  c5_e_q0 = c5_I12;
  c5_e_qY = c5_e_q0 - (uint32_T)c5_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 8, 0,
    c5_i_covSaturation);
  c5_I71 = (uint8_T)c5_u8;
  c5_b_a = 0.5 + c5_b_x;
  c5_c_b = c5_I41;
  c5_d4 = muDoubleScalarRound(c5_b_a * (real_T)c5_c_b);
  ...
  c5_c_a = 0.5 - c5_b_x;
  c5_d_b = c5_I51;
  c5_d5 = muDoubleScalarRound(c5_c_a * (real_T)c5_d_b);
  c5_k_covSaturation = false;
  if (c5_d5 < 256.0) {
    if (c5_d5 >= 0.0) {
      c5_u10 = (uint8_T)c5_d5;
    } else {
  ...
  c5_d_a = 0.5 + c5_b_x;
  c5_e_b = c5_I61;
  c5_d6 = muDoubleScalarRound(c5_d_a * (real_T)c5_e_b);
  c5_l_covSaturation = false;
  if (c5_d6 < 256.0) {
    if (c5_d6 >= 0.0) {
      c5_u11 = (uint8_T)c5_d6;
    } else {
  ...
  c5_e_a = 0.5 - c5_b_x;
  c5_f_b = c5_I71;
  c5_d7 = muDoubleScalarRound(c5_e_a * (real_T)c5_f_b);
  c5_m_covSaturation = false;
  if (c5_d7 < 256.0) {
    if (c5_d7 >= 0.0) {
      c5_u12 = (uint8_T)c5_d7;
    } else {
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 16, 0,
    c5_m_covSaturation);
  c5_k_y = c5_u12;
  c5_u13 = (uint32_T)c5_I31 + (uint32_T)c5_h_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 9, 0,
    c5_n_covSaturation);
  c5_u14 = (uint32_T)(uint8_T)c5_u13 + (uint32_T)c5_i_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 10, 0,
    c5_o_covSaturation);
  c5_u15 = (uint32_T)(uint8_T)c5_u14 + (uint32_T)c5_j_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c5_covrtInstance, 4, 0, 11, 0,
    c5_p_covSaturation);
  c5_u16 = (uint32_T)(uint8_T)c5_u15 + (uint32_T)c5_k_y;
  c5_q_covSaturation = false;
  if (c5_u16 > 255U) {
    c5_q_covSaturation = true;
    c5_u16 = 255U;
  ...
  (SFc5_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 4U, 558, -1,
    564);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 5U, 578, -1,
    588);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 6U, 669, -1,
    676);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 7U, 697, -1,
    704);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 8U, 724, -1,
    731);
  ...
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 11U, 744,
    -1, 785);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 12U, 744,
    -1, 797);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 13U, 748,
    -1, 761);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 14U, 762,
    -1, 773);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 15U, 774,
    -1, 785);
  covrtEmlSaturationInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 16U, 786,
    -1, 797);
}
   ...
   c5_ssIdNumber)
{
  ...
  switch (c5_ssIdNumber) {
   ...
   case 4U:
    c5_u = *chartInstance->c5_I1;
    sf_mex_assign(&c5_mxData, sf_mex_create("mxData", &c5_u, 3, 0U, 0U, 0U, 0),
                  false);
    break;

   case 5U:
    c5_u1 = *chartInstance->c5_y;
    sf_mex_assign(&c5_mxData, sf_mex_create("mxData", &c5_u1, 3, 0U, 0U, 0U, 0),
                  false);
    break;

   case 10U:
    c5_d1 = *chartInstance->c5_I2;
  ...
  (SFc5_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_x = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c5_I1 = (uint8_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(23354071U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(431798387U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3130592679U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2072564954U);
}
...
{
  return "sHkw389ubXjsphapNkAVD1E";
}
...
const char* sf_c5_untitled_restored_from_autosave_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV8tu00AUtUNBVAJUJCQ2IMqKLliAEFIREn3kAZESWpG2sAtT+yYeMp4x80jaD0HiG1iyYs2",
    "KLTvEV/AJ3HHcNHXsmDSiKhKWHHs85565r7l34rj1poPXNbw/XnecS/i8jHfJGV4Xk7E7dg+/Lz",
    "j3kvEaCnETbhNJQuVMvTgJ4RUowYymgtd5R2TCKO+ABO4hNhJS57EpGhpGea9muGf51OuAekErE",
    "Ib5myhL/C3ODpEtMnobeSpUgqdrAL4OpDDdoMZId6Sx1INyAF5PmXCaCQp0y0RWLdU0TNOIQfUA",
    "vDpXmqDG6li3liYayvog10xrqWodAUUYMUp4prUBUS2I0MEadiMff7eMRqPSMC8gUm9CQPqgGrQ",
    "XcwoOaU6qcGKfcqKFpIRVQ1a2gpO6bTPUpyl8YFMcgrptSiC9SFCu8+PfqqGlVU72GVRg33Tz2V",
    "rw3tjg71EYgMz1W6cs+iBJF7Z47qKxQ6oHcbRGWTIJ0zSEPSI3PIyfAj83ezFzVItgnGAHJfJgE",
    "BtZVzuS9tG9uWwmrNvMLNoyJhwGWxXBYrZqH6ZFYcRW83iZMKZyYTsiakAfWMxaIZpMhw1Zs3FK",
    "UX9HoINteufvBsMpBj6BlQX3aWa4+ilAXHdeYmE5ifSM0iIsY/JWGo3J6UlYnWuQHeJBVhWQhCp",
    "An8XuzWfzqbKxRyBqpWP1ssDDDClCOapjeGUgZA99MqWIHJtgI5oLDFUXY4k7YVfhppkGs7Eswn",
    "nEC8C3BYYyaOK2QWyGT5QtbRu47/pUH1ZAeZJGWVG1/eeBc9x/rvxB/zmSSz9XxnjcDB5n7Jled",
    "7F0En8htW4Jv7iuG8utj8ldTa2zkJKzuCW87/q3vw7Yz28fVj49/f7880rR+u7E+m78buW+lGbr",
    "19eS8a2jwjhK9P5EflnsizG9FjL4b47xLyVj9aI3eLT6xOy/eaeigEQvext7lYfVmO9ygb6llL5",
    "H35dthT6M4nqrpFf3k4OEHRMzbK+Wf3VM30sF/lhMvg+vX2vzyd9YT8dxoUB+Cd8OU3l7+vWX1+",
    "eTH67/tkD/+6l434/7cJvY3Q1t73HbcCxmDPy2BKxIEl86UoRtYrRQeCRJ79PT5v2scs4Zy/0re",
    "v73y9+370/62IVTyrlz9s2zkpvXvln7+XnDT+sLTgq/dI7tmPec9bfxP5zZzkN3kvGz0V+UckCZ",
    "n3FaTaYbQDpZs2dg32/WhaAh",
    ""
  };
...
static void mdlSetWorkWidths_c5_untitled_restored_from_autosave(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3256706081U));
  ssSetChecksum1(S,(3369757815U));
  ssSetChecksum2(S,(1001007253U));
  ssSetChecksum3(S,(682772433U));
}
