  ...
  int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 4:
      {
        if (strcmp(instanceChksum, "sbKMu0mEJysqk3UjsdrP2qD") == 0) {
          extern const mxArray
     ...
     case 5:
      {
        if (strcmp(instanceChksum, "sHkw389ubXjsphapNkAVD1E") == 0) {
          extern const mxArray
     ...
     case 7:
      {
        if (strcmp(instanceChksum, "s7wJ4atZy3dMvTwi8aAo5lG") == 0) {
          extern const mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sbKMu0mEJysqk3UjsdrP2qD") == 0) {
          extern mxArray
     ...
     case 5:
      {
        if (strcmp(tpChksum, "sHkw389ubXjsphapNkAVD1E") == 0) {
          extern mxArray
     ...
     case 7:
      {
        if (strcmp(tpChksum, "s7wJ4atZy3dMvTwi8aAo5lG") == 0) {
          extern mxArray
