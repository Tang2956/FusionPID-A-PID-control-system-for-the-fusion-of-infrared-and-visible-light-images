  ...
  (SFc4_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 2, 0,
    c4_c_covSaturation);
  c4_I23 = c4_u2;
  c4_d3 = muDoubleScalarRound((real_T)c4_b_I1 - c4_I22 * 255.0);
  ...
  if (c4_d3 < 256.0) {
    if (c4_d3 >= 0.0) {
      ...
      c4_u3 = 0U;
      sf_data_saturate_error(chartInstance->S, 1U, 551, 10);
    }
  } else if (c4_d3 >= 256.0) {
    c4_d_covSaturation = true;
    c4_u3 = MAX_uint8_T;
  ...
  if (c4_b_b) {
    ...
    c4_p = ((real_T)c4_a > c4_b);
  }

  if (c4_p) {
    c4_d4 = muDoubleScalarRound(c4_h_y);
    ...
    if (c4_d4 < 256.0) {
      if (c4_d4 >= 0.0) {
        ...
        c4_u5 = 0U;
        sf_data_saturate_error(chartInstance->S, 1U, 601, 10);
      }
    } else if (c4_d4 >= 256.0) {
      c4_f_covSaturation = true;
      c4_u5 = MAX_uint8_T;
  ...
  c4_d5 = muDoubleScalarRound(c4_I22 - (real_T)c4_I31);
  ...
  if (c4_d5 < 256.0) {
    if (c4_d5 >= 0.0) {
      ...
      c4_u6 = 0U;
      sf_data_saturate_error(chartInstance->S, 1U, 623, 7);
    }
  } else if (c4_d5 >= 256.0) {
    c4_g_covSaturation = true;
    c4_u6 = MAX_uint8_T;
  ...
  c4_I41 = c4_u6;
  c4_b_q0 = c4_I23;
  c4_b_qY = c4_b_q0 - (uint32_T)c4_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 7, 0,
    c4_h_covSaturation);
  c4_I51 = (uint8_T)c4_u7;
  c4_c_q0 = c4_I11;
  c4_c_qY = c4_c_q0 - (uint32_T)c4_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 8, 0,
    c4_i_covSaturation);
  c4_I61 = (uint8_T)c4_u8;
  c4_d_q0 = c4_I12;
  c4_d_qY = c4_d_q0 - (uint32_T)c4_I31;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 9, 0,
    c4_j_covSaturation);
  c4_I71 = (uint8_T)c4_u9;
  c4_b_a = 0.5 + c4_b_x;
  c4_c_b = c4_I41;
  c4_d6 = muDoubleScalarRound(c4_b_a * (real_T)c4_c_b);
  c4_k_covSaturation = false;
  if (c4_d6 < 256.0) {
    if (c4_d6 >= 0.0) {
      c4_u10 = (uint8_T)c4_d6;
    } else {
  ...
  c4_c_a = 0.5 - c4_b_x;
  c4_d_b = c4_I51;
  c4_d7 = muDoubleScalarRound(c4_c_a * (real_T)c4_d_b);
  c4_l_covSaturation = false;
  if (c4_d7 < 256.0) {
    if (c4_d7 >= 0.0) {
      c4_u11 = (uint8_T)c4_d7;
    } else {
  ...
  c4_d_a = 0.5 + c4_b_x;
  c4_e_b = c4_I61;
  c4_d8 = muDoubleScalarRound(c4_d_a * (real_T)c4_e_b);
  c4_m_covSaturation = false;
  if (c4_d8 < 256.0) {
    if (c4_d8 >= 0.0) {
      c4_u12 = (uint8_T)c4_d8;
    } else {
  ...
  c4_e_a = 0.5 - c4_b_x;
  c4_f_b = c4_I71;
  c4_d9 = muDoubleScalarRound(c4_e_a * (real_T)c4_f_b);
  c4_n_covSaturation = false;
  if (c4_d9 < 256.0) {
    if (c4_d9 >= 0.0) {
      c4_u13 = (uint8_T)c4_d9;
    } else {
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 17, 0,
    c4_n_covSaturation);
  c4_l_y = c4_u13;
  c4_u14 = (uint32_T)c4_I31 + (uint32_T)c4_i_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 10, 0,
    c4_o_covSaturation);
  c4_u15 = (uint32_T)(uint8_T)c4_u14 + (uint32_T)c4_j_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 11, 0,
    c4_p_covSaturation);
  c4_u16 = (uint32_T)(uint8_T)c4_u15 + (uint32_T)c4_k_y;
  ...
  covrtSaturationUpdateFcn(chartInstance->c4_covrtInstance, 4, 0, 12, 0,
    c4_q_covSaturation);
  c4_u17 = (uint32_T)(uint8_T)c4_u16 + (uint32_T)c4_l_y;
  c4_r_covSaturation = false;
  if (c4_u17 > 255U) {
    c4_r_covSaturation = true;
    c4_u17 = 255U;
  ...
  (SFc4_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 2U, 515, -1,
    532);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 3U, 551, -1,
    561);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 4U, 581, -1,
    587);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 5U, 601, -1,
    611);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 6U, 623, -1,
    630);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 7U, 694, -1,
    701);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 8U, 722, -1,
    729);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 9U, 749, -1,
    756);
  ...
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 12U, 770,
    -1, 811);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 13U, 770,
    -1, 823);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 14U, 774,
    -1, 787);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 15U, 788,
    -1, 799);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 16U, 800,
    -1, 811);
  covrtEmlSaturationInitFcn(chartInstance->c4_covrtInstance, 4U, 0U, 17U, 812,
    -1, 823);
   ...
   c4_ssIdNumber)
{
  ...
  switch (c4_ssIdNumber) {
   ...
   case 4U:
    c4_u = *chartInstance->c4_I1;
    sf_mex_assign(&c4_mxData, sf_mex_create("mxData", &c4_u, 3, 0U, 0U, 0U, 0),
                  false);
    break;

   case 5U:
    c4_u1 = *chartInstance->c4_y;
    sf_mex_assign(&c4_mxData, sf_mex_create("mxData", &c4_u1, 3, 0U, 0U, 0U, 0),
                  false);
    break;

   case 10U:
    c4_d1 = *chartInstance->c4_I2;
  ...
  (SFc4_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_x = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c4_I1 = (uint8_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2321063732U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3574044195U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4068532819U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2509610502U);
}
...
{
  return "sbKMu0mEJysqk3UjsdrP2qD";
}
...
const char* sf_c4_untitled_restored_from_autosave_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV09v00gUt0MXgbTLdqWVuIDgxh44IOCwp6U0f0SWZFuRFo5har/EsxnPuPNm3OaDIHFYCT4",
    "Gn4FPsEduXPcj8MZx0+DYMW1EBdJacuzx/N5v3r95b+L53b5H1zW6X//ieZfpeYXuhje7fsjH/s",
    "I9+77h3cnHj0hI2niXaRajt/KSLIZngEpYw5XsypEqhXE5Ag0yIGyitKliQx5bweWkY2Xg+PBFx",
    "INoECkrwm2SZeGOFFNiS6zZJZ4W1xCYDkBoIq3sOOoINp5rrM1RM4JggjZeZQKCGdjEqYV9KwxP",
    "BLSPIehKNIw0xlPdBoYZaJrjSjOdpTg4Aao4EZzJUmsjhgNIyMEG9pOQfnesIaOKsCBi2mxDxFL",
    "AHp9knEpCkZMjTRxwyYzSnIl2LJpOcFm3XUH69FUIYoVDSLdtDWySKC5NdfwHHbK0LdmBgBYc2H",
    "E12wAOrQv+cw5HoCv9NmqqFDQbw46sXDRzSPs4i9Y8S5ZhhsfwnOnHAcUPIazMXsocHDCKE+yRR",
    "BUMMiO7uKd5Su6tZLNx12Vm3Zax8SzYWAfL2NoprIrCnK0TyCYTAitheyrpQQoiY20xw1bDZqzl",
    "OEQe7ilysEvv6t1gJafA57CmkiEvDVdaAGR15y8qLJ8jA4tGxU1K3lavtzy9DOtKA3rEAiirApp",
    "xBPJZ5t5qtpCjiz0BSSuTqVcGnmVIHcrDkZWtI6Un5JMVReTUBBfRSmCMY4ol7YR9pE2zCuZiWY",
    "cLWBBB6AoMF9CnbUPYEp+gK22Pad+l3ExbgIHmSVlUXf+55532nx+/oP+cyBWfvy3w+CU83sKzu",
    "O7Vxuf4S4V1G/TF9/1MbmtB7qfCOhsFOYfbdM8P72/2f74fv1Uf36Q7/7yqW99fWt/P3p3cu8bZ",
    "+vW1fHzjpDDOEz1dyi+HfbKg10YJ//UF/s18jAdP+/Ze3P5zioeTB/t/Y6h37x+2Mr4rNfo2Cvq",
    "efL/tKvQ0yeot6qAb5gcJN2Z21l4d/+8L+l6u8cfV/Pvs+u/RevK/bhXjuFEjv0lv00Lenn/921",
    "vryc/Wf1mj/91CvO9mfXjI3O6GYfBwaCUVMwHhUANVJE0vI63iIbNGIR1Jivv0vHl/VjnvguW+F",
    "z3/98vXt+9L+tilc8r5a/bNi5Jb176z9vNvDb+qL3gF/OY3bMe656yvjf/XO9t56FY+/mP+F6UZ",
    "cRGWnFbz6R6wUdnsBdj3CbtxoD4=",
    ""
  };
...
static void mdlSetWorkWidths_c4_untitled_restored_from_autosave(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(499834886U));
  ssSetChecksum1(S,(1831997261U));
  ssSetChecksum2(S,(2682744736U));
  ssSetChecksum3(S,(2510049142U));
}
