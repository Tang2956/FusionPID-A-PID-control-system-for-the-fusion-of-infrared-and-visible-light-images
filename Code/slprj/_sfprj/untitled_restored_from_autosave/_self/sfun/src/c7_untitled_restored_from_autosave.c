...
static emlrtMCInfo c7_c_emlrtMCI = { 13,/* lineNo */
  9,                                   /* colNo */
  "sqrt",                              /* fName */
  "D:\\Program Files\\Polyspace\\toolbox\\eml\\lib\\matlab\\elfun\\sqrt.m"/* pName */
};

static emlrtMCInfo c7_d_emlrtMCI = { 13,/* lineNo */
  13,                                  /* colNo */
  "toLogicalCheck",                    /* fName */
  "D:\\Program Files\\Polyspace\\toolbox\\eml\\eml\\+coder\\+internal\\toLogicalCheck.m"/* pName */
};
...
static emlrtRSInfo c7_j_emlrtRSI = { 58,/* lineNo */
  "conv2",                             /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\eml\\lib\\matlab\\datafun\\conv2.m"/* pathName */
};
...
static emlrtRSInfo c7_l_emlrtRSI = { 105,/* lineNo */
  "conv2",                             /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\eml\\eml\\+coder\\+internal\\conv2.m"/* pathName */
};

static emlrtRSInfo c7_m_emlrtRSI = { 29,/* lineNo */
  "conv2AXPY",                         /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\eml\\eml\\+coder\\+internal\\private\\conv2AXPY.m"/* pathName */
};
...
static emlrtRSInfo c7_q_emlrtRSI = { 178,/* lineNo */
  "edge",                              /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\images\\images\\eml\\edge.m"/* pathName */
};
...
static emlrtRSInfo c7_eb_emlrtRSI = { 37,/* lineNo */
  "bwpack",                            /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\images\\images\\eml\\bwpack.m"/* pathName */
};
...
static emlrtRSInfo c7_gb_emlrtRSI = { 37,/* lineNo */
  "bwunpack",                          /* fcnName */
  "D:\\Program Files\\Polyspace\\toolbox\\images\\images\\eml\\bwunpack.m"/* pathName */
};
...
static emlrtBCInfo c7_emlrtBCI = { 1,  /* iFirst */
  ...
  "",                                  /* aName */
  "padarray",                          /* fName */
  "D:\\Program Files\\Polyspace\\toolbox\\images\\images\\eml\\padarray.m",/* pName */
  3                                    /* checkKind */
};
   ...
   c7_ssIdNumber)
{
  ...
  switch (c7_ssIdNumber) {
   ...
   case 11U:
    c7_u = *chartInstance->c7_I1;
    sf_mex_assign(&c7_mxData, sf_mex_create("mxData", &c7_u, 3, 0U, 0U, 0U, 0),
                  false);
    break;

   case 12U:
    c7_d2 = *chartInstance->c7_I2;
  ...
  (SFc7_untitled_restored_from_autosaveInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_y = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c7_I1 = (uint8_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2157027715U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(985923005U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(120307904U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1904699924U);
}
...
{
  return "s7wJ4atZy3dMvTwi8aAo5lG";
}
...
const char* sf_c7_untitled_restored_from_autosave_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV0tv00oUttOAingoV7oSGxDsYNEFj3sFiytomwcEJbQiAaS7yZ3aJ/Eo4xkzD6f5J/wUfgF",
    "/gA1L1qz4CZxx3DR17Jg2ogLpWnLs8Xznm/OacyaO2+46eF3D+/0fjnMRn5t4V5zZdSEduwv37H",
    "vVuZOOn6IQN+E+kSRUzsqLkxBegRLMaCp4mw9FLozyIUjgHmIjIXURm6KhYZSPW4Z7lk+9DagX9",
    "AJhmL+LssTf42yKbJHR+8jToBI83QLwdSCFGQUtRkZzjaWe1APwxsqEq0xQoHsmsmqprmGaRgya",
    "h+C1udIENVbHuvU00VDXh4VmWktV7wgowohRwnOtDYjqQYQO1vA68vF3z2g0KgvzAiL1LgQkBtW",
    "h44RTcMhyUoUTB5QTLSQlrBmyuhVc1m2foT5d4QNb4RDUbVcCGUeCcl0c/14LLW1ycsCgAQdmVM",
    "zWg3fGBv8NhQnIQr8N6yIGSUawxwsXTRzSPEyiNc+SZZimIbwhcsfD+CnwC7MXM0f1CMYJ+ihRB",
    "IPEyLbqSxqjewvZTNi2mVm2ZUw4C7YqgyVszRhWRWHO1vJ4nTCmCmF9EXUgBpawNogmq2Ez1nyc",
    "UtTvC3SwTe/i3WA4xcCnsLrgPs0NV5wBJHXnJRaWk0jPKC3COiZvo9NZnl6GtbkGOSQe5FUBSag",
    "C9Fni3mI2nyobewSiVjpRLw88y5AylKOGhjcmQo7RJyuKyLEJNqKFwFCNMJa4E14r3DSrYDaWZT",
    "iPeAH4tsBQBl3cNojN8YmypW0H911M9bQBypM0youq7T/3nOP+c+UH+s+RXPZ5d4HHzeFxFp7Zd",
    "S9VTuI3MutW8Ivruonc9oLc1cw61YycxdXwvr/x4NPmPzcnu5c/9r98rdbK1neX1neTdyv3oXK6",
    "fn0tHd84KozzRI+X8stiny/oVc3hv77AX0vH6tHkxV9E/zt96Hfj/oQ+Jjvib/Ys4dss0beS0ff",
    "o+21boadRUm+V9Np+epCwY2Jm7dXyP17Q92KJPy6l32fXt6fryf+5nY1jtUS+hm/TTN6eff3b2+",
    "vJz9b/r0T/rUy8t5I+PCB2d8PAezQwHIsZA38gASuSxJehFOGAGC0UHkmy+/SseX9aOeec5X4XP",
    "f/3y8+370f62MYZ5dw1++Z5ya1r32n7+a+GX9UXnAy+9gvbse4562fjPzunOw/dSsdP5n9R6gFl",
    "fs5pNZ3uABnmzZ6Dfd8BKAqeAg==",
    ""
  };
...
static void mdlSetWorkWidths_c7_untitled_restored_from_autosave(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3543270193U));
  ssSetChecksum1(S,(1998404616U));
  ssSetChecksum2(S,(1422265154U));
  ssSetChecksum3(S,(268757728U));
}
