#ifndef __MATLAB0_sfun_h__
#define __MATLAB0_sfun_h__
...
extern mxArray* load_MATLAB0_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_MATLAB0_optimization_info(void);
